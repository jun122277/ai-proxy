...
M1-02 と M1-03 の SRE 設計・実装は利用者が担当します。AI はモック、SDK 契約テスト、再現環境、レビューを補助し、タイムアウト、キャンセル、drain、計測を先回りして完成させません。[着手ガイド](docs/exercises/m1-lifecycle.md) に現在の引き継ぎ点を記載します。
